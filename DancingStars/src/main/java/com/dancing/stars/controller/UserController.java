...
//        return ResponseEntity.ok(userDTOs);
    ...
    public ResponseEntity<UserDTO> createUser(@RequestParam String email, @RequestParam String password) throws BadRequestException {
        User result = service.createUser(email, password);
        return ResponseEntity.ok(mapper.entityToDTO(result));
    }

    @PostMapping("/login")
    public ResponseEntity<UserDTO> login(@RequestParam String email, @RequestParam String password) throws BadRequestException, UnauthorizedException {
